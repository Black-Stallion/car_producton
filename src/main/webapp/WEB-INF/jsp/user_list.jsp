...
<table class="easyui-datagrid" id="userList" title="用户列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'userEdit',align:'center',width:50,formatter:formatUserEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		$("#userList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'userEdit', width : 50, align:'center', title : '编辑',formatter:formatUserEdit}
	        ] ],  
	    });
	}else{
		$("#userList").datagrid({  
...
function  formatUserEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='user_edit()'><span style='color:blue'>编辑</span></a>";
};
