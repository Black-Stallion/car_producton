...
<table  id="fCountCheckList" title="派车列表" class="easyui-datagrid"
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'fCountCheckId',align:'center',width:100">编号</th>
            <th data-options="field:'orderId',align:'center',width:100,formatter:formatOrder">用车单位</th>
            <th data-options="field:'checkItem',align:'center',width:100">派车人</th>
            <th data-options="field:'sample',align:'center',width:100">地点及路线</th>
            <th data-options="field:'checkNumber',align:'center',width:100">驾驶员</th>
            <th data-options="field:'unqualify',align:'center',width:100">用车人</th>
            <th data-options="field:'qualify',align:'center',width:100">合格率</th>
            <th data-options="field:'cdate',align:'center',width:130,formatter:TAOTAO.formatDateTime">车牌号</th>
            <th data-options="field:'measureData',align:'center',width:100">派单日期</th>
            <th data-options="field:'empName',align:'center',width:100,formatter:formatEmp_fCount">出车日期</th>
            <th data-options="field:'result',align:'center',width:100">返回日期</th>
            <th data-options="field:'note',align:'center',width:100,formatter:formatFCountCheckNote">第一责任人</th>
            <th data-options="field:'result',align:'center',width:100">领导审批</th>
            <th data-options="field:'note',align:'center',width:100,formatter:formatFCountCheckNote">行走公里</th>
            <th data-options="field:'note',align:'center',width:100,formatter:formatFCountCheckNote">注意事项</th>
        </tr>
    </thead>
</table>
...
<div id="fCountCheckEditWindow" class="easyui-window" title="编辑派车单" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'f_count_check/edit'" style="width:40%;height:50%;padding:10px;">
</div>
<div id="fCountCheckAddWindow" class="easyui-window" title="添加派车单" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'f_count_check/add'" style="width:40%;height:50%;padding:10px;">
</div>
<!-- ********************************************************************* -->
