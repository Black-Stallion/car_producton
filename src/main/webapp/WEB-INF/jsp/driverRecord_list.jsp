...
<table class="easyui-datagrid" id="driverRecordList" title="司机行驶里程表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'driverRecordEdit',align:'center',width:50,formatter:formatDriverRecordEdit">编辑</th>
        </tr>
    </thead>
</table> 
...
function  formatDriverRecordEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='driverRecord_edit()'><span style='color:blue'>编辑</span></a>";
};
//格式化行驶里程记录记录信息
