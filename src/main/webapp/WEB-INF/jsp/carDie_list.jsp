...
<table class="easyui-datagrid" id="carDieList" title="车辆回收列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'dieEdit',align:'center',width:50,formatter:formatDieEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		...
		$("#carDieList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'dieEdit', width : 50, align:'center', title : '编辑',formatter:formatDieEdit}
	        ] ],  
	    });
	}
}

function  formatDieEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carDie_edit()'><span style='color:blue'>编辑</span></a>";
};
