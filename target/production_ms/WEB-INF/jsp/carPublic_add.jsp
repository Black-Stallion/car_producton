	 ...
	 <center>
	    <table class="border-table"  cellpadding="5" algin="center">
	        ...
	        <tr>
	            ...
	            <td>
	            	<input class="easyui-combobox" id="departmenCombox10158" data-options="required:true" panelHeight="150"/>
	            	<input name="departmentFrist" id="departmentFrist" type="hidden"/>
    				<input name="departmentId" id="departmentId8" type="hidden"/>
    				<!-- 
    				<input class="easyui-combobox" id="departmenCombox10158" data-options="required:true" panelHeight="auto" size="8px" />
	            	<input name="departmentFrist" id="departmentFrist" type="hidden"/>
    				<input class="easyui-combobox" id="department10158"  panelHeight="200" size="11px"/>  
    				<input name="departmentId" id="departmentId8" type="hidden"/>
    				 -->
	            </td>
		      </tr>
...
$(function(){
	...
	function submitCarRegisterAddForm(){
		...
		$.post("carPublic/check",$("#carRegisterAddForm").serialize(),function(data){
       		if(data.msg != null){
	...
	$('#departmenCombox10158').combobox({  
      ...
      //  panelHeight:'auto',  
        onSelect : function(data){  
            ...
            $('#departmentId8').val(data.departmentId);  
       //     var fatherdep= $('#departmentFrist').val();
       //     $('#department10158').combobox({  
       //         url:"department/get_data_second/"+fatherdep,  
       //         editable:false,  
        //        valueField:'departmentId',  
        //        textField:'departmentName' ,
       //         onSelect : function(data1){  
        //          $('#departmentId8').val(data1.departmentId);  
       //         }
       //     }).combobox('clear');  
        }  
    });  
