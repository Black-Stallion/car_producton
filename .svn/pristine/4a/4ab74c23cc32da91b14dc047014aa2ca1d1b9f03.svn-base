...
<table class="easyui-datagrid" id="processList" title="工序列表" 
       data-options="singleSelect:false,collapsible:true,pagination:true,rownumbers:true,url:'process/list',method:'get',pageSize:30,fitColumns:true,toolbar:toolbar_process">    <thead>
        <tr>
        	...
        	<th data-options="field:'processId',width:100,align:'center'">编号</th>
            <th data-options="field:'technologyPlanId',width:100,align:'center',formatter:formatTechnologyPlan_process">时间</th>
            <th data-options="field:'sequence',width:100,align:'center'">违章地点</th>
            <th data-options="field:'quota',width:100,align:'center'">违章原因</th>
            <th data-options="field:'sequence1',width:100,align:'center'">扣分</th>
            <th data-options="field:'sequence2',width:100,align:'center'">罚款/元</th>
            <th data-options="field:'quota1',width:100,align:'center'">主车司机</th>
        </tr>
    </thead>
</table>
...
<div  id="toolbar_process" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_process" style="float: right;">
        ...
        <div id="menu_process" style="width:120px"> 
			<div data-options="name:'processId'">编号</div> 
			<div data-options="name:'technologyPlanId'">主车司机</div> 
		</div>     
    </div>  

</div> 

<div id="processEditWindow" class="easyui-window" title="编辑违章记录" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'process/edit'" style="width:60%;height:60%;padding:10px;">
</div>
<div id="processAddWindow" class="easyui-window" title="添加违章记录" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'process/add'" style="width:60%;height:60%;padding:10px;">
</div>
	...
	if(value == null || value == ''){
		...
		$("#processList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'processId', width : 100, align:'center', title : '编号'},
	             	{field : 'technologyPlanId', width : 100, align : 'center', title : '时间', formatter:formatTechnologyPlan_process},
	             	{field : 'sequence', width : 100, align : 'center', title : '违章地点'}, 
	             	{field : 'quota', width : 100, title : '违章原因', align:'center'},
	             	{field : 'sequence1', width : 100, align : 'center', title : '扣分'}, 
	             	{field : 'sequence2', width : 100, align : 'center', title : '罚款/元'}, 
	             	{field : 'quota1', width : 100, title : '主车司机', align:'center'}
	        ] ],  
	    });
	}else{
		$("#processList").datagrid({  
