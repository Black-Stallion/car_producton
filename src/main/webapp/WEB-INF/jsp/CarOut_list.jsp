...
<table class="easyui-datagrid" id="carOutList" title="车辆调出列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'outEdit',align:'center',width:50,formatter:formatOutEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		...
		$("#carOutList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'outEdit', width : 50, align:'center', title : '编辑',formatter:formatOutEdit}
	        ] ],  
	    });
	}else{
		$("#carOutList").datagrid({
...
function  formatOutEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carOut_edit()'><span style='color:blue'>编辑</span></a>";
};
