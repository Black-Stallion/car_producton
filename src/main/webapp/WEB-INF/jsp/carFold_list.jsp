...
<table class="easyui-datagrid" id="carFoldList" title="文件列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'foldEdit',align:'center',width:50,formatter:formatFoldEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		$("#carFoldList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'foldEdit', width : 50, align:'center', title : '编辑',formatter:formatFoldEdit}
	        ] ],  
	    });
	}else{
		$("#carFoldList").datagrid({
...
function  formatFoldEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carFold_edit()'><span style='color:blue'>编辑</span></a>";
};
