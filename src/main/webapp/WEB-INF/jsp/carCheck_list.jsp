...
<table class="easyui-datagrid" id="carCheckList" title="月检记录表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'checkEdit',align:'center',width:50,formatter:formatCheckEdit">编辑</th>
        </tr>
    </thead>
</table> 
	...
	if(value == null || value == ''){
		$("#carCheckList").datagrid({
	        ...
	        columns : [ [
	            	...
	            	{field : 'checkEdit', width : 50, align:'center', title : '编辑',formatter:formatCheckEdit}
	             	 ] ],  
	    });
	}else{
		$("#carCheckList").datagrid({
...
function  formatCheckEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carCheck_edit()'><span style='color:blue'>编辑</span></a>";
};
               	...
               	$("#carCheckEditWindow").window({
               		onLoad :function(){
        				...
        				data.usenature = data.register.usenature;
               			send2AddEditor.html(data.carquestion);
