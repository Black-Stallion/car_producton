	...
	<form id="customAddForm" class="customForm" method="post">
	    <table cellpadding="5" >
	        ...
	        <tr>
	            <td>到场人数:</td>
	            <td>
	            	应到<input class="easyui-textbox" type="text" name="address" style="width: 280px;" size="3">人</input>
	            	实到<input class="easyui-textbox" type="text" name="address" style="width: 280px;" size="3">人</input>
	            </td>
	        </tr>
	         <tr>
	            <td>实到人员:</td>
