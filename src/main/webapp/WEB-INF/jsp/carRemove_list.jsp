...
<table class="easyui-datagrid" id="carRemoveList" title="车辆异动列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'removeEdit',align:'center',width:50,formatter:formatRemoveEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		$("#carRemoveList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'removeEdit', width : 50, align:'center', title : '编辑',formatter:formatRemoveEdit}
	        ] ],  
	    });
	}else{
		$("#carRemoveList").datagrid({
...
function  formatRemoveEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carRemove_edit()'><span style='color:blue'>编辑</span></a>";
};
