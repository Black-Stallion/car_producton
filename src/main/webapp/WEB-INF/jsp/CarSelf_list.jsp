...
<table class="easyui-datagrid" id="carSelfList" title="段内调配列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'selfEdit',align:'center',width:50,formatter:formatSelfEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		$("#carSelfList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'selfEdit', width : 50, align:'center', title : '编辑',formatter:formatSelfEdit}
	        ] ],  
	    });
	}else{
		$("#carSelfList").datagrid({
...
function  formatSelfEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carSelf_edit()'><span style='color:blue'>编辑</span></a>";
};
