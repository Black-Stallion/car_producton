...
<table class="easyui-datagrid" id="carApplyList" title="用车申请列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'sta',width:160,align:'center',formatter:formatSN">申请结果</th>
        </tr>
    </thead>
</table> 
...
<div id="carApplyEditWindow" class="easyui-window" title="修改用车申请" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'carApply/edit'" style="width:800px;height:530px;padding:15px;">
</div>
<div id="carApplyAddWindow" class="easyui-window" title="新增用车申请" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'carApply/add'" style="width:800px;height:530px;padding:15px;">
</div>
	...
	if(value == null || value == ''){
		$("#carApplyList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'car773', width :80, title : '申请车辆', align:'center',formatter:formatCarNumber},
	             	...
	             	{field : 'sta', width : 160, title : '申请结果', align:'center',formatter:formatSN}
	        ] ],  
	    });
	}else{
		$("#carApplyList").datagrid({
