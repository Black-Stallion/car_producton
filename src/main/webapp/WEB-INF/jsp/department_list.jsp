...
<table class="easyui-datagrid" id="departmentList" title="部门列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'departmentEdit',align:'center',width:50,formatter:formatDepartmentEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		...
		$("#departmentList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'departmentEdit', width : 50, align:'center', title : '编辑',formatter:formatDepartmentEdit}
	        ] ],  
	    });
	}else{
		$("#departmentList").datagrid({  
...
function  formatDepartmentEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='department_edit()'><span style='color:blue'>编辑</span></a>";
};
