...
<table class="easyui-datagrid" id="carBigList" title="所换大件记录表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'bigEdit',align:'center',width:50,formatter:formatCBigEdit">编辑</th>
        </tr>
    </thead>
</table> 
		...
		$("#carBigList").datagrid({
	        ...
	        columns : [ [ 
	            	...
	            	{field : 'changedate', width : 100, title : '更换日期', align:'center',formatter:TAOTAO.formatDateTime}, 
	             	...
	             	{field : 'bigEdit', width : 50, align:'center', title : '编辑',formatter:formatCBigEdit}
	        ] ],  
	    });
	}else{
		$("#carBigList").datagrid({
...
function  formatCBigEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carBig_edit()'><span style='color:blue'>编辑</span></a>";
};
