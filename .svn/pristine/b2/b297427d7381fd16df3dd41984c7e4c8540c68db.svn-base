...
<table class="easyui-datagrid" id="manufactureList" title="技术月检列表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'manufactureSn',align:'center',width:150">日期</th>
            <th data-options="field:'cOrder',align:'center',width:150,formatter:formatManuOrder">车况评分</th>
            <th data-options="field:'technology',align:'center',width:150">存在问题</th>
            <th data-options="field:'beginDate',width:130,align:'center'">处理结果</th>
        </tr>
    </thead>
</table>
...
<div  id="toolbar_manufacture" style=" height: 22px; padding: 3px 11px; background: #fafafa;">  
    ...
    <div id="search_manufacture" style="float: right;">
        ...
        <div id="menu_manufacture" style="width:120px"> 
			<div data-options="name:'manufactureSn'"></div> 
			<div data-options="name:'manufactureOrderId'"></div> 
			<div data-options="name:'manufactureTechnologyName'"></div>
		</div>     
    </div>  

</div>  

<div id="manufactureEditWindow" class="easyui-window" title="编辑月检记录" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'manufacture/edit'" style="width:51%;height:65%;padding:10px;">
</div>
<div id="manufactureAddWindow" class="easyui-window" title="添加月检记录" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'manufacture/add'" style="width:51%;height:65%;padding:10px;">
</div>
	...
	if(value == null || value == ''){
		...
		$("#manufactureList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'manufactureSn', width : 150, title : '时间', align:'center'},
	             	{field : 'cOrder', width : 100, align : 'center', title : '车况评分', formatter:formatManuOrder},
	             	{field : 'technology', width : 100, align : 'center', title : '存在问题', formatter:formatManuTechnology}, 
	             	{field : 'beginDate', width : 130, title : '处理结果', align:'center', formatter:TAOTAO.formatDateTime}, 
	        ] ],  
	    });
	}else{
		$("#manufactureList").datagrid({  
