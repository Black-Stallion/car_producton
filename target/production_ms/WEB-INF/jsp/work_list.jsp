...
<table class="easyui-datagrid" id="workList" title="维保列表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'workId',align:'center',width:100">维保开始时间</th>
            <th data-options="field:'processNumber',align:'center',width:100">维保结束时间</th>
            <th data-options="field:'product',align:'center',width:100,formatter:formatWorkProduct">间隔里程</th>
            <th data-options="field:'process',align:'center',width:100,formatter:formatWorkProcess">维护级别或项目</th>
            <th data-options="field:'device',align:'center',width:100,formatter:formatWorkDevice">厂家名称</th>
        </tr>
    </thead>
</table>
...
<div id="workEditWindow" class="easyui-window" title="编辑维保" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'work/edit'" style="width:40%;height:55%;padding:10px;">
</div>
<div id="workAddWindow" class="easyui-window" title="添加维保" data-options="modal:true,closed:true,resizable:true,
	iconCls:'icon-save',href:'work/add'" style="width:30%;height:35%;padding:10px;">
</div>
