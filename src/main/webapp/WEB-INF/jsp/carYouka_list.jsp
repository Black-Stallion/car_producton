...
<table class="easyui-datagrid" id="carYoukaList" title="车辆用油信息" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'carYoukaEdit',align:'center',width:50,formatter:formatCarYoukaEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		...
		$("#carYoukaList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'carYoukaEdit', width : 50, align:'center', title : '编辑',formatter:formatCarYoukaEdit}
	        ] ],  
	    });
	}else{
		$("#carYoukaList").datagrid({
...
function  formatCarYoukaEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carYouka_edit()'><span style='color:blue'>编辑</span></a>";
};
