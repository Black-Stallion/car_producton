...
<div style="padding:10px 10px 10px 10px">
	<form id="carTypeEditForm15" class="carTypeForm" method="post">
...
<script type="text/javascript">
	...
	function submitCarTypeEditForm(){
		if(!$('#carTypeEditForm15').form('validate')){
			$.messager.alert('提示','表单还未填写完成!');
			return ;
		}
		
		$.post("carType/update_all",$("#carTypeEditForm15").serialize(), function(data){
			if(data.status == 200){
				$.messager.alert('提示','修改车型成功!','info',function(){
					$("#carTypeEditWindow").window('close');
