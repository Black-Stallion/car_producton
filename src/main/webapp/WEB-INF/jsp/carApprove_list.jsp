...
<table class="easyui-datagrid" id="carApproveList" title="信息列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'stats',width:60,align:'center'">审批状态</th>
        </tr>
    </thead>
</table> 
...
<div id="carApproveEditWindow" class="easyui-window" title="用车审批" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'carApprove/edit'" style="width:800px;height:490px;padding:10px;">
</div>
	...
	if(value == null || value == ''){
		$("#carApproveList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'stats', width : 60, title : '审批状态', align:'center'}
	        ] ],  
	    });
	}
}
