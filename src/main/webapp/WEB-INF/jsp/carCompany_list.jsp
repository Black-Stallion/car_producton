...
<table class="easyui-datagrid" id="carCompanyList" title="定点保养单位表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'companyEdit',align:'center',width:50,formatter:formatCompanyEdit">编辑</th>
        </tr>
    </thead>
</table>
...
function  formatCompanyEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carCompany_edit()'><span style='color:blue'>编辑</span></a>";
};
