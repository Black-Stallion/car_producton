...
<table class="easyui-datagrid" id="carDriverList" title="信息列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'driverEdit',align:'center',width:50,formatter:formatDriverEdit">编辑</th>
        </tr>
    </thead>
</table> 
		...
		$("#carDriverList").datagrid({
	        ...
	        columns : [ [ 
	            	...
	            	{field : 'drivernum', width : 100, title : '驾驶证号', align:'center'}, 
	             	...
	             	{field : 'driverEdit', width : 50, align:'center', title : '编辑',formatter:formatDriverEdit}
	        ] ],  
	    });
	}else{
		$("#carDriverList").datagrid({
...
function  formatDriverEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carDriver_edit()'><span style='color:blue'>编辑</span></a>";
};
