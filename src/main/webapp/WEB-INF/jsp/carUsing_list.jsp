...
<table class="easyui-datagrid" id="carUsingList" title="运用记录表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'carUsingEdit',align:'center',width:50,formatter:formatCarUsingEdit">编辑</th>
        </tr>
    </thead>
</table> 
		...
		$("#carUsingList").datagrid({
	        ...
	        columns : [ [
	            	...
	            	{field : 'monthtime', width : 100, title : '趟数', align:'center'}, 
	             	...
	             	{field : 'carUsingEdit', width : 50, align:'center', title : '编辑',formatter:formatCarUsingEdit}
	        ] ], 
	    });
	}else{
		$("#carUsingList").datagrid({
...
function  formatCarUsingEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carUsing_edit()'><span style='color:blue'>编辑</span></a>";
};
//格式化车型信息
