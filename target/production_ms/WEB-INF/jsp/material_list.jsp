...
<table class="easyui-datagrid" id="materialList" title="技术月检列表" 
    ...
    <thead>
         <tr>
        	...
        	<th data-options="field:'materialId',align:'center',width:100">时间</th>
            <th data-options="field:'materialType',align:'center',width:100">车况评分</th>
            <th data-options="field:'status',width:100,align:'center',formatter:TAOTAO.formatMaterialStatus">存在问题</th>
            <th data-options="field:'note',width:100,align:'center', formatter:formatMaterialNote">处理结果</th>
