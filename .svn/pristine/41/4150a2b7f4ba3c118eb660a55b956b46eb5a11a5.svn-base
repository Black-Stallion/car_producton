...
<table class="easyui-datagrid" id="technologyList" title="工艺列表" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'technologyId',width:100,align:'center'">编号</th>
            <th data-options="field:'technologyName',width:100,align:'center'">事故日期</th>
            <th data-options="field:'price',width:100,align:'center'">地点</th>
            <th data-options="field:'vitalProcessPeriod',width:140,align:'center'">事故类型</th>
            <th data-options="field:'standardCapacity',width:140,align:'center'">责任</th>
            <th data-options="field:'overtimeStandardCapacity',width:160,align:'center'">原因</th>
            <th data-options="field:'overtimeOverfulfilCapacity',width:160,align:'center'">损失情况</th>
            <th data-options="field:'doubleCapacity',width:140,align:'center'">主车司机</th>
        </tr>
    </thead>
</table>
...
<div id="technologyEditWindow" class="easyui-window" title="编辑事故记录" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'technology/edit'" style="width:55%;height:55%;padding:10px;">
</div>

<div id="technologyAddWindow" class="easyui-window" title="添加事故记录" data-options="modal:true,closed:true,resizable:true,iconCls:'icon-save',href:'technology/add'" style="width:55%;height:55%;padding:10px;">
</div>
	...
	if(value == null || value == ''){
		...
		$("#technologyList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'technologyId', width : 100, align:'center', title : '编号'},
	             	{field : 'technologyName', width : 100, align : 'center', title : '事故日期'},
	             	{field : 'price', width : 100, align : 'center', title : '地点'}, 
	             	{field : 'vitalProcessPeriod', width : 140, title : '事故类别', align:'center'}, 
	             	{field : 'standardCapacity', width : 140, title : '责任', align:'center'}, 
	            	{field : 'overtimeStandardCapacity', width : 160, title : '原因', align:'center'}, 
	             	{field : 'overtimeOverfulfilCapacity', width : 160, title : '损失情况', align:'center'}, 
	             	{field : 'doubleCapacity', width : 140, title : '主车司机', align:'center'}, 
	        ] ],  
	    });
	}else{
		$("#technologyList").datagrid({  
