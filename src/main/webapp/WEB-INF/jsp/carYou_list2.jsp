...
<table class="easyui-datagrid" id="carYouList" title="油卡信息" 
    ...
    <thead>
        <tr>
        	...
        	<th data-options="field:'carYouEdit',align:'center',width:50,formatter:formatCarYouEdit">编辑</th>
        </tr>
    </thead>
</table>
	...
	if(value == null || value == ''){
		...
		$("#carYouList").datagrid({
	        ...
	        columns : [ [ 
	             	...
	             	{field : 'carYouEdit', width : 50, align:'center', title : '编辑',formatter:formatCarYouEdit}
	        ] ],  
	    });
	}else{
		$("#carYouList").datagrid({
...
function  formatCarYouEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carYou_edit()'><span style='color:blue'>编辑</span></a>";
};
