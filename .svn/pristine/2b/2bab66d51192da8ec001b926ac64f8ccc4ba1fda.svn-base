...
<div style="padding:10px 10px 10px 10px">
	<form id="taskAddForm" class="userForm" method="post">
	<center>
	    <table cellpadding="5" >
	     <tr>
	            <td>时间:</td>
	        ...
	        <tr>
	            <td>备注:</td>
	            <td>
	                <textarea style="width:600px;height:300px;visibility:hidden;" name="note"></textarea>
	            </td>
	        </tr>
	    </table>
	    </center>
...
//页面初始化完毕后执行此方法
	$(function(){
		...
		taskAddEditor = KindEditor.create("#taskAddForm [name=note]", TT.kingEditorParams);
	});
	//提交表单
