...
<table class="easyui-datagrid" id="carTypeList" title="车型列表" 
    ...
    <thead>
        <tr>
            ...
            <th data-options="field:'carTypeEdit',align:'center',width:50,formatter:formatCarTypeEdit">编辑</th>
        </tr>
    </thead>
</table> 
...
function  formatCarTypeEdit(value, row, index){ 
	return "<a herf='#' style='cursor:pointer' icon='icon-edit' onclick='carType_edit()'><span style='color:blue'>编辑</span></a>";
};
